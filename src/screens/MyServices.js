...
const MyServices = ({ navigation }) => {
      ...
      return (
            ...
            <View style={styles.view}>
                  <TouchableOpacity style={{ width: '100%' }} onPress={() => navigation.navigate('OpenServices')}>
                  ...
                  <TouchableOpacity style={{ width: '100%' }} onPress={() => navigation.navigate('PendingServices')}>
                        <Card style={styles.card}>
                  ...
                  <TouchableOpacity style={{ width: '100%' }} onPress={() => navigation.navigate('ServiceHistory')}>
                        <Card style={styles.card}>
