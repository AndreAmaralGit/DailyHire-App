...
export default class ServiceHistoryWorker extends Component {
      ...
      getData = () => {
            ...
            this.setState({
                  services: [], appliedAlert: false, showAlert: false, evaluateModal: false
            })
            ...
            fetch('http://localhost:8080/workers/findWorkerbyUser', {
                  ...
                  fetch('http://localhost:8080/relations/findRelationbyWorker', {
                        ...
                        for (let i = 0; i < responseText2.length; i++) {
                              ...
                              if (responseText2[i].service[0].state == 'Completed') {
      ...
      ratingCompleted(rating) {
            ...
            fetch('http://localhost:8080/services/updateClientRating', {
                  method: 'POST',
                  headers: {
                        Accept: 'application/json',
                        'Content-Type': 'application/json',
            ...
            return (
                  ...
                  <ScrollView
                        ...
                        <View style={styles.view}>
                              ...
                              {this.state.noServices ? <Text style={{ marginTop: 10 }}>No service history</Text> : null}
                                          ...
                                          return (
                                                <View>
                                                      ...
                                                      <Card style={styles.card}>
                                                            ...
                                                            {item.service[0].clientRating == null ?

                                                                  <Card.Actions >

                                                                        <View style={{ width: '100%', alignItems: 'flex-end' }}>
                                                                              <Button onPress={() => this.setState({ evaluateModal: true, selectedService: item.service[0]._id })}>Rate the client</Button>
                                                                        </View>
                              ...
                              <Modal
                                    isVisible={this.state.evaluateModal}
                                    onBackdropPress={() => this.setState({ evaluateModal: false })}
                              >
